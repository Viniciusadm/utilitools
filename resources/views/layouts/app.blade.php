...
<header class="bg-p-light dark:bg-p-dark text-b-light dark:text-b-dark">
    <div class="lg:w-4/5 xl:w-3/5 mx-auto grid grid-cols-1 md:grid-cols-2 px-2 lg:px-0">
        <div class="flex items-center justify-center md:justify-start pt-4 pb-2 lg:pb-4">
            <a href="{{ route('home') }}" class="text-2xl font-bold text-white">
                UtiliTools
            </a>
        </div>

        <div class="flex items-center justify-center md:justify-end pt-2 pb-4 lg:pt-4">
