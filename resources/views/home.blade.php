...
@section('meta')
    ...
    <meta property="og:description"
          content="Ferramentas úteis online para testes, desenvolvimento e estudos. Geradores de CPF, CNPJ, números, editores de texto entre outras para agilizar a vida de programadores.">
