...
@section('title', 'Validar RG - IFP RJ')

@section('meta')
    <meta name="title" content="Validar RG - IFP RJ">
    ...
    <meta property="og:title" content="Validar RG - IFP RJ">
...
@vite('resources/ts/pages/validate.rj.ts')
