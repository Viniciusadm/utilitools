...
@section('content')
    ...
    @component('components.warning')
        <span class="fw-bold">NOTA:</span> O gerador de CNPJ fornecido tem exclusivamente propósitos educacionais, destinando-se à avaliação de sites, softwares e outros.
        Os números são gerados aleatoriamente, respeitando as normas de formação do CNPJ. Não nos responsabilizamos por qualquer uso indevido.
