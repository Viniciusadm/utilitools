...
@section('title', 'Gerador de RG - IFP RJ')

@section('meta')
    <meta name="title" content="Gerador de RG - IFP RJ">
    <meta name="description" content="Gerador de RG - IFP RJ. Você pode escolher se quer pontuação ou não.">
    ...
    <meta property="og:title" content="Gerador de RG - IFP RJ">
    <meta property="og:description" content="Gerador de RG - IFP RJ. Você pode escolher se quer pontuação ou não.">
    <meta property="og:url" content="{{ route('generate.rg') }}">
@endsection

@section('content')
    <h1 class="text-2xl font-semibold mb-2 sm:mb-3">
        Gerador de RG - IFP RJ
    </h1>

    <a
        href="{{ route('validate.rj') }}"
    ...
    <p class="mb-2 sm:mb-3">
        Gerador de RG - IFP RJ. Você pode escolher se quer pontuação ou não.
...
@vite('resources/ts/pages/generate.rj.ts')
