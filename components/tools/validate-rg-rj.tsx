...
function validateRgRjDigits(rg: string): boolean {
...
export default function ValidateRGRJ() {
  ...
  const handleValidate = () => {
    ...
    setIsValid(validateRgRjDigits(clean));
  };

  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Validar RG – IFP RJ</h1>
        <p className="mt-2 text-muted-foreground">
          Valide números de RG no padrão IFP RJ de forma rápida e gratuita. Digite o RG abaixo e
          descubra se ele é válido de acordo com a regra de cálculo do dígito verificador.
        </p>
        <Link href="/gerar-rj" className="text-primary hover:underline text-sm mt-2 inline-block">
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        <div className="space-y-2">
          <Label htmlFor="rg-rj-input">RG</Label>
          <Input
            id="rg-rj-input"
      ...
      <div className="space-y-6 text-muted-foreground">
        <section>
          ...
          <p>
            ...
            emitido pelos órgãos de segurança pública de cada estado e é amplamente utilizado para
            identificação em diversas situações.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            No estado do Rio de Janeiro, o RG segue o padrão do Instituto Félix Pacheco (IFP RJ),
            que utiliza um sistema de verificação baseado em cálculos matemáticos para validar a
            autenticidade do número.
          </p>
        </section>
      ...
      <section>
        ...
        <ul className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          {[
            ...
            { label: "Validar RG – SSP SP", to: "/validar-rg" },
